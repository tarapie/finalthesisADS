...
# Save these objects as .RDS files in the results folder
# Boolean vectors
saveRDS(pc_recover, paste0("results/boolean_results_pc_June2021.RDS"))
saveRDS(kpc_recover, paste0("results/boolean_results_kpc_June2021.RDS"))

# Returned DAGs
saveRDS(pc_res, paste0("results/dags_results_pc_June2021.RDS"))
saveRDS(kpc_res, paste0("results/dags_results_kpc_June2021.RDS"))
